...
<section id="hero" class="hero section">
  ...
  <div class="container text-center">
    <div class="d-flex flex-column justify-content-center align-items-center">
      ...
      <p data-aos="fade-up" data-aos-delay="100" class="">Quickly start your project now and set the stage for
        success<br></p>
      ...
      <img src="{{ asset('assets/img/hero-services-img.webp') }}" class="img-fluid hero-img" alt="" data-aos="zoom-out"
        data-aos-delay="300">
    </div>
  </div>
    ...
    <div class="row justify-content-md-center">
      <div class="col-md-9 ">
        ...
        <ul class="nav nav-tabs" id="myTab" role="tablist">
          ...
          <li class="nav-item" role="presentation">
            <button class="nav-link " id="kode_booking_tab" data-bs-toggle="tab" data-bs-target="#kode_booking"
              type="button" role="tab" aria-controls="booking" aria-selected="true">Booking</button>
          </li>
        </ul>
          ...
          <div class="card px-5 py-4 mt-5 shadow">
            ...
            <form action="/post" method="post">
              ...
              <div class="form-class">
                ...
                <input type="file" class="form-control mb-3" name="bukti_bayar" accept="image/*" required>
              </div>
              <div class="form mt-4">
